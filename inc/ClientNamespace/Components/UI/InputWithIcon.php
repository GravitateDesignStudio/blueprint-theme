...
class InputWithIcon implements IComponent
{
	...
	public function render(): void
	{
		...
		?>
		<<?php echo $tag_container; ?> <?php echo Util::attributes_array_to_string($this->container_attrs); ?>>
			<input <?php echo Util::attributes_array_to_string($this->input_attrs); ?> />
			<<?php echo $tag_icon; ?> <?php echo Util::attributes_array_to_string($this->icon_container_attrs); ?>>
