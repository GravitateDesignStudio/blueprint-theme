...
class ShareIcon implements IComponent
{
	...
	public function render(): void
	{
		...
		?>
		<a class="<?php echo esc_attr(implode(' ', $this->button_classes)); ?>" href="<?php echo esc_url(SocialShare::get_social_share_link($this->site_slug, $this->post_id)); ?>" <?php echo $attrs_str; ?>>
